...
class CategoryFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return prepareNumbersFragment();
        } else if (position == 1) {
            return prepareColorsFragment();
        } else if (position == 2) {
            return prepareFamilyFragment();
        } else {
            return preparePhrasesFragment();
        }
    }
    ...
    private Fragment prepareColorsFragment() {
    ...
    private Fragment prepareNumbersFragment() {
        Bundle bundle = new Bundle();
        ...
        // Put the word list and the color Id to the bundle
        bundle.putParcelableArrayList("WORD_LIST", words);
        bundle.putInt("COLOR_ID", R.color.category_numbers);
    ...
    private Fragment prepareFamilyFragment() {
        Bundle bundle = new Bundle();
    ...
    private Fragment preparePhrasesFragment() {
        Bundle bundle = new Bundle();
        ...
        // Put the word list and the color Id to the bundle
        bundle.putParcelableArrayList("WORD_LIST", words);
        bundle.putInt("COLOR_ID", R.color.category_phrases);
